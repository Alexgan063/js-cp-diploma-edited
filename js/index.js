...
import { createElement } from './createDOMStruct.js';
import { createDateElementHTML } from './navigationElemOnIndex.js';
import { createDateElementDataAttributes } from './navigationElemOnIndex.js';
import { sendRequest } from './requestToApi.js';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  pageNavDayList.forEach((pageNavDay) => {
    ...
    // Добавляем отметки для выходных
    
    if ( pageNavDay.querySelector('.page-nav__day-week').textContent === 'сб' ||  pageNavDay.querySelector('.page-nav__day-week').textContent === 'вс'){
        pageNavDay.classList.add('page-nav__day_weekend');
    }
  });
